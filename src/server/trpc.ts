...
export const appRouter = t.router({
  ...
  store: t.router({
    ...
    updateOwners: t.procedure
      ...
      .mutation(({ input }) =>
        storesService.updateStoreOwner(input.id, input.newOwnerIds.map(Number)),
      ),
    ...
    incrementRevenue: t.procedure
      ...
      .mutation(({ input }) =>
        storesService.incrementRevenue(input.storeId, input.revenue),
      ),
    ...
    decreaseRevenue: t.procedure
      ...
      .mutation(({ input }) =>
        storesService.decreaseRevenue(input.storeId, input.revenue),
      ),
  }),
  ...
  quote: t.router({
    getQuotesByStoreId: t.procedure
      .input(z.string())
      .query(({ input }) => quoteService.getQuotesByStoreId(input)),
    getById: t.procedure
    ...
    updateOrderOnAndShippingOn: t.procedure
      ...
      .mutation(({ input }) =>
        quoteService.updateOrderOnAndShippingOn(
          input.id,
          input.orderDate,
          input.shippingOn,
        ),
    ...
    updatePaymentType: t.procedure
      ...
      .mutation(({ input }) =>
        quoteService.updatePaymentType(
          input.id,
          input.type === "cash" ? PaymentType.cash : PaymentType.credit,
          input.creditTerm,
        ),
  ...
  quoteProduct: t.router({
    create: t.procedure
      ...
      .mutation(({ input }) =>
        quoteproductService.createQuoteProduct(
          input.quoteId,
          input.productId,
          input.quantity,
          input.unitPrice,
    ...
    update: t.procedure
      ...
      .mutation(({ input }) =>
        quoteproductService.updateQuoteProduct(input.id, input.data),
      ),
    ...
    deleteQuoteProduct: t.procedure
      ...
      .mutation(({ input }) =>
        quoteproductService.deleteQuoteProductById(
          input.quoteId,
          input.productId,
        ),
      ),
  ...
  quoteCustomer: t.router({
    create: t.procedure
      ...
      .mutation(({ input }) =>
        quoteCustomerService.createQuoteCustomer(
          input.quoteId,
          input.customerId,
          input.name,
          input.phoneNumber,
    ...
    update: t.procedure
      ...
      .mutation(({ input }) =>
        quoteCustomerService.updateQuoteCustomer(input.id, input.data),
      ),
  }),
});
